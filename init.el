(custom-set-variables
 ...
 ;; Indentation Setup for Bash Shell. 
 '(sh-basic-offset 2)
 '(sh-indentation 2)
 '(smie-indent-basic 2)
 ;; end
 ...
 '(package-selected-packages
   (quote
    (yasnippet flycheck color-theme zenburn-theme auto-complete counsel swiper org-bullets which-key try use-package)))
...
;; The above are automatic lines, don't mess with them if you don't know how 
